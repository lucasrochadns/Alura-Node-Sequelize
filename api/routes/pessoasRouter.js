...
router.get('/pessoas/matricula/:turma_id/confirmados', PessoaController.pegaMatriculasPorTurma);
...
router.put('/pessoas/:estudante_id/cancelaMatricula', PessoaController.cancelaMatricula);
